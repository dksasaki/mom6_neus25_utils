...
class Glofas2mat_avg:
    ...
    def read_multiple_years(self):
        ...
        ys = self.config['year_first']
        yf = self.config['year_final']
    ...
    def _read_glofas(self, year: int):
        ...
        fpath = osp.join(self.config['path_source'], f'glofas_runoff_{year}.nc')
    ...
    def _savemat(self):
        ...
        ds = self.ds
        fpath = self.config['path_savemat']
